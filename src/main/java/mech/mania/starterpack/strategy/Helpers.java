...
public class Helpers{
    ...
    )   {return new AbilityAction(_currentPerson.id(), "None", _buildPosition,AbilityActionType.BUILD_BARRICADE);}
    public static AbilityAction Heal(
        Character _currentPerson,
        Character _healTarget
    )   {return new AbilityAction(_currentPerson.id(), _healTarget.id(), null,AbilityActionType.BUILD_BARRICADE);}
